...
const FAQS = [
  {
    ...
    answer:
      "You can register by visiting the Tournament Registration page, filling out the form with your In-Game ID, team name, mobile number, and selecting a time slot. Pay the entry fee via UPI to confirm your slot.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "All matches are played in the classic battle mode. Cheating, hacking, teaming with enemies, or using third-party software results in immediate disqualification. Tournament decisions by organizers are final.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Winners are decided based on the total points scored in all matches, combining placement points and kill points according to the official point system.",
  },
];

export async function generateMetadata(): Promise<Metadata> {
  return generateDynamicMetadata("faq");
}
