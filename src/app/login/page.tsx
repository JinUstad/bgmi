...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: `${getURL()}user-dashboard`,
      },
    });
  };
      ...
      <div className="container relative z-10 mx-auto px-4 w-full max-w-md">
        ...
        <Card className="p-8 border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 border border-white/20 rounded-lg text-white font-bold uppercase tracking-widest text-sm hover:bg-white/5 transition-colors disabled:opacity-50"
          >
