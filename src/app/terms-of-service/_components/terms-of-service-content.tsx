...
/**
 * Terms of Service Content — Client Component
        ...
        <div className="container relative mx-auto px-4">
          <div className="max-w-2xl text-left">
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-5xl md:text-7xl font-black font-heading uppercase tracking-tighter text-white mb-4 leading-none">
              TERMS OF<br />
              <span className="text-[var(--theme-primary)] text-glow">SERVICE</span>
            </motion.h1>
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-white/80 text-lg md:text-xl font-medium max-w-md">
