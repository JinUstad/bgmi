    ...
    <div className="flex flex-col w-full min-h-screen bg-black relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute inset-0 bg-[url('/war_game_bg.png')] bg-cover bg-center mix-blend-overlay" 
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/80 to-black z-10" />
        
        {/* Laser Sights (Terms Theme - Orange & Red) */}
        <motion.div
          animate={{
            x: ["-20vw", "120vw", "-20vw"],
            y: ["30vh", "70vh", "40vh"],
          ...
          className="absolute h-[2px] w-[40vw] bg-orange-500/60 shadow-[0_0_15px_rgba(249,115,22,0.8)] z-10 top-0 left-0 origin-left"
        />
        <motion.div
          animate={{
            x: ["120vw", "-20vw", "120vw"],
          ...
          className="absolute h-[2px] w-[55vw] bg-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.8)] z-10 top-0 left-0 origin-left"
        />
      </div>
      ...
      <section className="relative pt-32 pb-20 border-b border-white/10 z-10">
        <div className="container relative mx-auto px-4 text-center">
          ...
          >
            <ShieldAlert className="w-8 h-8 text-pubg-yellow" />
          </motion.div>
          <motion.h1
          ...
          >
            Terms & <span className="text-pubg-yellow">Conditions</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Rules & Regulations for Tournament Participants
          </motion.p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="mb-16">
            <h2 className="text-3xl font-black font-heading uppercase text-white mb-8 border-b border-white/10 pb-4 flex items-center gap-3">
              <AlertTriangle className="text-pubg-yellow w-8 h-8" />
              ...
              {RULES.map((rule, index) => (
                ...
                >
                  <Card className="p-6 h-full flex items-start gap-4 hover:border-pubg-yellow/50 transition-colors group bg-black/40 backdrop-blur-md">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white/5 flex items-center justify-center border border-white/10 text-pubg-yellow font-bold group-hover:bg-pubg-yellow/20 group-hover:border-pubg-yellow/50 transition-all">
                      {index + 1}
                    </div>
