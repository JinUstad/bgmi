        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/blogs" className="text-white/90 font-medium hover:text-pubg-yellow transition-colors">Blogs</Link></li>
              <li><Link href="/registration" className="text-white/90 font-medium hover:text-pubg-yellow transition-colors">Contact Us</Link></li>
